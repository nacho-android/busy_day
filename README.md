...
> **Production status:** GitHub Pages currently serves the merged V2.0 baseline from `main` at [`54499b3`](https://github.com/nacho-android/busy_day/commit/54499b368d566f3fa4e7da1af3e7a06ed1942b2f). Its Node 24 workflow [`29298026940`](https://github.com/nacho-android/busy_day/actions/runs/29298026940) passed the recorded clean release/audio/type/lint/27-unit/build gates and Playwright 21/21. The V2.1 working tree documented below expands that baseline to 18 objectives and adds the hardening features described in the changelog; it is not described as deployed until its own final workflow and Pages checks complete. Public-control Mel/Josh completion, physical-device/controller, audio-listening, screen-reader, soak/current-phone-performance, and rights-review gates remain open.
