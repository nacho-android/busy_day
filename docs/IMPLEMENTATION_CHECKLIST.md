...
| 2026-07-15 | V2.1 cross-engine CI regression rechecks | Pass locally — Firefox full-story 1/1; WebKit full story, phone touch, and gamepad 3/3 sequentially; WebKit exit directions 1–6 plus phone touch 2/2; WebKit built preview 2/2 after tracing and removing a pre-dialogue visibility race. Final clean GitHub matrix remains pending. |
