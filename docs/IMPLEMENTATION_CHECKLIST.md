...
| 2026-07-14 | V2.1 working-tree `npm run verify:release` | Pass — V1 size/hash; 43-reference inventory/integrity/exclusion; 11 backgrounds; eight portraits; 26 WAVs; manifest/docs/links; file-size and selected credential-pattern gates; 139 intended files / 50.26 MiB. Final-commit rerun still required. |
