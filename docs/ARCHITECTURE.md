...
`scripts/optimize_art.mjs` maps scene masters to centre-cropped 1280×720 WebP outputs at quality 88 / effort 5. The complete 11-background runtime set is 1,777,598 bytes (1.695 MiB). Eight 384×384 portrait WebPs are cropped from one retained 2048×1024 master. `scripts/build_runtime_art.ps1` packs the Mel/Josh and 23 NPC directional sheets plus animal, trolley, vehicle, and facility-prop atlases; frame contracts remain in data and are decoded in unit tests. Replacing any generated room requires regenerating its WebP, and a composition that changes doors, fixtures, or obstacle silhouettes also requires updating the corresponding `LocationDefinition` geometry.
...
The historical V2.0 baseline merged to `main` as [`54499b3`](https://github.com/nacho-android/busy_day/commit/54499b368d566f3fa4e7da1af3e7a06ed1942b2f). V2.1 then merged through [PR #2](https://github.com/nacho-android/busy_day/pull/2) as [`d5bc627`](https://github.com/nacho-android/busy_day/commit/d5bc627235f70865290b34e8efe28824debb1e54); main workflow [`29350906888`](https://github.com/nacho-android/busy_day/actions/runs/29350906888) and [Pages job `87149283383`](https://github.com/nacho-android/busy_day/actions/runs/29350906888/job/87149283383) succeeded. Production served `assets/index-DEBHc20z.js` and `assets/index-CyZvj29T.css`; hosted smoke verified the title, New Shift confirmation, opening dialogue, Tea Room HUD objective 0/1, refresh/Continue recovery, all 18 objectives in the objective drawer, and zero console entries.
