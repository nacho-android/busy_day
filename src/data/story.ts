...
export const OBJECTIVES: readonly ObjectiveDefinition[] = [
  ...
  { id: 'restore_routes', act: 0, title: 'Restore the morning routes', description: 'The overnight reset has locked the feed-store release and confidently mislabelled two corridors.', hint: 'Use the route-control console beneath the glowing map in Main Hall.', location: 'mainHall', targets: ['route_console'], reward: { xp: 14, coins: 7 }, grantsFlags: ['routesRestored'] },
  ...
  { id: 'feed_baboons', act: 1, title: 'Feed each baboon', description: 'Calm pace, no sprinting at the cages, and absolutely no improvisational fruit juggling.', hint: 'The secured Baboon Wing is through the north hall door.', location: 'baboonWing', targets: ['baboon_feed_1', 'baboon_feed_2', 'baboon_feed_3'], reward: { xp: 20, coins: 10 }, grantsFlags: ['baboonsFed'] },
  { id: 'secure_baboon_wing', act: 1, title: 'Calibrate the wing interlock', description: 'The sample hatches have entered a trust exercise with the security panel.', hint: 'Operate the amber interlock beside the third baboon station.', location: 'baboonWing', targets: ['security_panel'], reward: { xp: 18, coins: 9 }, grantsFlags: ['wingSecured'] },
  ...
  { id: 'sync_cath_monitors', act: 3, title: 'Synchronise the monitor bank', description: 'The monitor clock has drifted seven seconds into a more exciting timeline.', hint: 'Operate the cyan monitor bank before beginning procedure support.', location: 'cathLab', targets: ['heart_monitor'], reward: { xp: 20, coins: 10 }, grantsFlags: ['monitorSynced'] },
...
export const OBJECTIVE_DIALOGUE: Readonly<Record<string, readonly DialogueLine[]>> = {
  restore_routes: [{ speaker: 'Ross', text: 'The route computer says Feed Store is in Car Park B. I support its imagination, but not operationally.', expression: 'concerned' }],
  ...
  secure_baboon_wing: [{ speaker: 'Dhanya', text: 'Feeding complete. Calibrate the interlock, then the sample hatches will stop having opinions.', expression: 'neutral' }],
  ...
  sync_cath_monitors: [{ speaker: 'Tony', text: 'The monitor bank is seven seconds ahead. Synchronise it before the waveform predicts a meeting.', expression: 'concerned' }],
